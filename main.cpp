...
//to load the find mean function
...
//to find the variance of column
...
//to load the find variance function
void loadvar(int ch){
    int row = -1;
    int col = -1;
    int rc;
...
//to load the find correlation function
