...
void deleteuser(vec);
vec loadfile();
void clearfile(struct datavalues d);
int database(struct datavalues d);//changed
void savefile();
...
int database(struct datavalues d)
{   
    vec1 rowdata;
    string temp3, temp4;
    int temp5;
    ...
    cout<<" struct here "<<d.totalrow<<endl;
    viewfunc(d);
}
