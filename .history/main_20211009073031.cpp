...
void deleteuser(string name)
{
    ...
    if (found)
    {
        ...
        for (int i = 0; i < data.size(); i++)
        {
            ...
            users << data[i].username << " " << data[i].password << " " << data[i].type << " " << data[i].statue << endl;
        }
        cout << "*************" << endl;
        cout << " the user has been sessfuly deleted " << endl;
        cout << "*************" << endl;
