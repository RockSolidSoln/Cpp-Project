...
{   
    if(s==1)
    {
        ...
        cout << "-----------------------------------------------------\n"
            << "       Hello admin "<<name<<"                         \n"
            << "-----------------------------------------------------\n"
            << "| Please Enter from the choice given below            Account|\n"
            << "| Enter 1 to Create a New User Account                   |\n"
            << "| Enter 2 to Logout from your User Account               |\n"
            << "| Enter 3 to Login to as a User Account to view function |\n"
    ...
    {   
        ...
        {   
            ...
            cout << "-----------------------------------------------------\n"
                ...
                << "| Enter 1 to Logout from your User Account          |\n"
