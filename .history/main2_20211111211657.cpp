...
void printhist(structure datavalues d, int , int upperlimit)
void reportsmenu();
...
void findhistogram(struct datavalues d)
{
    ...
    {   
        ...
        {   
            printhist(d,lowlimit,upperlimit);
            lowlimit+=10;
            upperlimit+=10;
        }
        cout << setw(16) << "/";
...
void printhist(structure datavalues d, int lowlimit, int upperlimit)
{
    int v=0, count=0;
    for(int i = 0; i < d.totalrow ; i++) 
    { 
