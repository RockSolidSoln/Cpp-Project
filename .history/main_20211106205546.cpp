...
int database(struct datavalues d,string filename)
{   
    ifstream data;
    data.open(filename);
    if(!data){
...
void pressenter(int flag,struct datavalues d)
{
    char temp = 'x';
