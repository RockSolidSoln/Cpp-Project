...
void viewfunc();
void loadmean();
void findrowmean(int&, float&, double&, double&);
void findcolmean(int&, float&, double&, double&);
void loadvar();
...
void adminmenu()
{
    ...
    cin >> ch;
    cin.ignore(' ','\n');
    string str=username+" just choose menu option "+ch;
    logrecord(str);
    switch(ch)
    {
        case('1') : viewfunc();
...
void viewfunc()
{
    ...
    cin>>ch;
    cin.ignore(' ','\n');
    string str= " just choose a menu option from all the functions "+ ch;
    logrecord(str);
    switch(ch)
    {
         case('1')    : //findMin()
...
void findrowmean(int &row,float &rowmean,double &rowsum,double &rowsqsum)
{
    rowsum = 0;
    rowsqsum = 0;
    rowmean = 0;
    ...
    logrecord(" just calculated the mean of the row ");
}

//---------------------------------------------Liew ------------------------------------------------------
//------------------------------This functions finds the mean of the cloumn-----------------------------------------
void findcolmean(int &col,float &colmean,double &colsum,double &colsqsum)
{
    colsum = 0;
    colsqsum = 0;
    colmean = 0;
    ...
    logrecord(" just calculated the mean of the column ");
}
...
void findrowvar(int &row,float &rowmean,double &rowsum,double rowsqsum,double &rowvar)
{
    ...
    logrecord(" just calculated the variance of the row ");
}
...
void findcolvar(int &col,float &colmean,double &colsum,double colsqsum,double &colvar)
{
    ...
    logrecord(" just calculated the variance of the column ");
}
...
void findrowstdv(int &row,float &rowmean,double &rowsum,double rowsqsum,double &rowvar,double &rowstdv)
{
    ...
    logrecord(" just calculated the standard deviation of the row ");
}
...
void findcorrelation(int &col,float &colmean,double &colsum,double &colsqsum,double &corr)
{
    ...
    logrecord(" just calculated the correlation of the row ");
}
...
void finddistinct()
{
    ...
    logrecord(" just founf out the distinct member ");
    viewfunc();
}
