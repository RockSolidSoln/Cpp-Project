...
void loadvar(int);
void findrowvar(int ch,int &row,float &rowmean,double &rowsum,double rowsqsum,double &rowvar)void findcolstdv(int ch,int &col,float &colmean,double &colsum,double colsqsum,double &colvar, double &colstdv)
