...
{   
    ...
    cin>>n;
    {
        if(n==1)
        {
            ...
            {   
                getadminchoice(username,status);
            }
            else
            {   
                status=0;
                getuserchoice(username,status);
            }
        }
        else
            if(n==0)
...
//----------------------This functions takes the input from the admin and calls different functions---------------
void getchoice(string admin,us) 
{   
    int ch;
    cout << "-----------------------------------------------------\n"
        << "|            Hello "<<admin<<"                       |\n"
 ...
 checkadmin(string name,string pass) //this functions checks if the given data is of admin or not
 {      
    int status;
