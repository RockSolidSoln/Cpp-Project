...
void adminmenu(string name)
{
    int ch;
        ...
        switch(ch)
        {
            case(1) : createuser(name);
                        break;
            case(2) :  logout(name);
                        break;
            case(3) : viewfunc();
                        break;
            case(4) :  deleteuser(name);
                        break;
...
//---------------------------------------------Ahmad Ayaan------------------------------------------------------
//----------------------This functions shows the menu for a regular user---------------
...
{   
    ...
    int status;
    cin>>status;
    string str=name+"just created another user as "+user;
    logrecord(str);
    ofstream outfile;
...
{   
    string str=name+" logged out from the system ";
    logrecord(str);
    system("cls");
