     ...
     for (auto elem: users)
    {
        if (name == get<0>(elem) &&
             ...
             {  
                ...
                vector<tuple<string,int,string,int>> users1;
                tuple<string,int,string,int> userdata1;
                 while (file<<get<0>(userdata1))
                    {   get<3>(elem)=0;
                        file << get<1>(userdata1);
                        file << get<2>(userdata1);
                        file << get<3>(userdata1);
                        users.push_back(userdata1);
                    }
                cout<<get<3>(elem);
