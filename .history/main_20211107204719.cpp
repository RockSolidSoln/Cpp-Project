...
void loadmin(struct datavalues d)
{
    ...
    findmin(d, col, row, roworcol, min, count);
...
void findmin(struct datavalues d,const int col,const int row, const int roworcol,double &sum,double &sumofsq,double &mean,int &count)
{   
    // int choice;
    // double min=0.0;
