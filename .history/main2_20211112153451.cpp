...
void sortnum(struct datavalues d, int *ar, const int col,const int row,const int roworcol,int med,int &size)
{
    int minipos;
    int temp;
    if(roworcol==2)
...
void findmedian(struct datavalues d, const int col,const int row,const int roworcol,int med)
{
    ...
    {   
        ...
        sortnum(d,ar,col,row,roworcol,med,size);
        // for (int i=0;i<d.totalrow;i++)
        // {
        //     if(size % 2!=0)
        //     {
    ...
    {   
        ...
        if(size % 2==0)
            ...
            med=ar[(d.totalrow-1)/2];
        for(int i=0;i<d.totalcol;i++)
            cout<<ar[i]<<" ";
    //     for (int j=0;ar[j];j++)
    //     {
    //         if (d.computablecols[j]==1 && ar[j] %2 != 0)
    //         {
    //            if(size % 2!=0){
    //                med = (ar[j/2]);
    //            } 
