...
vec loadfile();
void clearfile();
int database(string,int**,string[],int,int);
void savefile();
...
void pressenter(int);
void viewfunc(int**,int,int);
void loadmin(int**,int,int);
void minrow(int);
...
int database( string filename, int **arr2, string arr1[], int row, int column )
{   
