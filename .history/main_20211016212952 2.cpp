...
{   
    if(status==1)
    {
        ...
        cout << "---------------------------------------------------------\n"
            ...
            << "----------------------------------------------------------\n";
        cin >> ch;
        string str=name+" just choose menu option "+ ch(string);
        logrecord(str);
        switch(ch)
        {
            case(1) : createuser();
    ...
    {   
        ...
        {   
            ...
            cout << "---------------------------------------------------------\n"
                ...
                << "---------------------------------------------------------\n";
            cin >> ch;
            string str=name+" just choose menu option "+ch;
            logrecord(str);
            switch(ch)
            {   case(1) : viewfunc(); 
                            break;
...
{   string user,pass;
    ...
    int status;
    cin>>status;
    string str=user+"just created another user with status of "+ string(status);
    logrecord(str);
    ofstream outfile;
